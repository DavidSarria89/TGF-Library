...
* The data file `tgf_fluence_data.mat` contains:
    ...
    * `energy_threshold_list` : the list of available minimum energy thresholds (20, 50, 100, 200, 300, 400, 500, 750 and 1000 keV) for photon records
...
* example: `my_fluence = get_TGF_fluence(11,30,530,120,400)` (TGF located at 11 km, sigma of 30 deg, record altitude of 530 km, radial distance of 120 km, record energy threshold of 400 keV) gives `my_fluence = 0.0055`
